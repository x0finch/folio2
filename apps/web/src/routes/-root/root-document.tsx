  ...
  return (
    <html lang={locale} suppressHydrationWarning>
      <head>
        ...
        {/* iOS 主屏启动图(ADR 0051):每种 iPhone 竖屏尺寸一条,media 匹配机型。它把 logo 画在和网页
            splash **完全一致**的位置/大小 —— iOS 从启动图无缝切到网页,避免「图标启动 → 网页」那下 logo
            位置/大小跳变。静态直渲(带 media,不走 head() 的 links 以免 TanStack 处理差异)。 */}
