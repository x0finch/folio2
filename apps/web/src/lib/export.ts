...
// 红线:account 的 safeCreds 由 @folio/balances safeView 在 route 算好后传入(secret 丢、semi 打码、public 留)。
...
// 账户记录。safeCreds 须为已脱敏的 creds(由 route 经 @folio/balances safeView 算出:public 原样、semi 打码、无 secret)。
