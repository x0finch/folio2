...
import { createOracleFor, createOracleWarm, type OracleFor, type OracleWarm } from "@folio/oracle";
import {
...
// 一个 import 是 D1 store,一个是 CoinGecko adapter;`@folio/oracle` 自己两边都不认识。
