...
const en = {
  ...
  Settings: {
    ...
    autoLock: "Auto-lock",
    autoLockDesc:
      "Blur your holdings after you step away — pick how many minutes of inactivity before it locks. Unlock with a passkey or password.",
    autoLockAfter: "Idle",
    autoLockNever: "Never",
...
const zh: Messages = {
  ...
  Settings: {
    ...
    autoLock: "自动锁定",
    autoLockDesc: "离开一会儿就遮住持仓 —— 选择闲置多少分钟后锁定;回来用 passkey 或密码解锁。",
    autoLockAfter: "闲置",
    autoLockNever: "永不",
    appearance: "外观",
    theme: "主题",
