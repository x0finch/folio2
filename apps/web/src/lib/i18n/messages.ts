...
export const en = {
  ...
  Accounts: {
    ...
    coinPickHint: "Type a symbol or name to link a coin for live pricing (optional).",
    coinLinked: "Linked to {coinId} — valued at market price.",
...
export const zh: Messages = {
  ...
  Accounts: {
    ...
    coinPickHint: "输入币种代号或名称以关联实时价格(可选)。",
    coinLinked: "已关联 {coinId} — 按市场价估值。",
    fixedLabel: "锁定固定值",
