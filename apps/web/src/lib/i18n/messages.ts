...
const en = {
  ...
  Settings: {
    ...
    autoLockUnlock: "Unlock in a tap with a passkey — or your password.",
    autoLockAfter: "Idle",
    autoLockNever: "Never",
    ...
    passkeys: "Passkeys",
    passkeysHint: "Register a passkey to sign in with Face ID, Touch ID, or a security key.",
...
const zh: Messages = {
  ...
  Settings: {
    ...
    autoLockUnlock: "用 passkey 一刷即解锁 —— 也可以用密码。",
    autoLockAfter: "闲置",
    autoLockNever: "永不",
    appearance: "外观",
    theme: "主题",
    ...
    passkeysHint: "注册 passkey,用 Face ID、Touch ID 或安全钥匙登录。",
    passkeyUnsupported: "当前浏览器不支持 passkey。",
    passkeysEmpty: "还没有注册 passkey。",
