...
export const en = {
  ...
  Accounts: {
    ...
    coin: "Coin",
    clearCoin: "Clear",
    searchCoinPlaceholder: "Search by name or symbol — e.g. Bitcoin or BTC",
    searching: "Searching…",
    searchFailed: "Search failed. Check your connection and try again.",
    noResults: "No matching coins",
    ...
    searchInstead: "Search for a coin instead",
    change: "Change",
    selectCoinRequired: "Select a coin, or switch to manual entry.",
...
export const zh: Messages = {
  ...
  Accounts: {
    ...
    coin: "代币",
    clearCoin: "清除",
    searchCoinPlaceholder: "按名称或符号搜索 —— 如 Bitcoin 或 BTC",
    searching: "搜索中…",
    ...
    change: "更换",
    selectCoinRequired: "请选择代币,或切换为手动输入。",
    fixedLabel: "锁定固定值",
