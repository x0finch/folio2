...
export const en = {
  ...
  Settings: {
    ...
    stateActive: "Active",
    stateOff: "Not enabled",
    stateUnconfigured: "Needs configuration",
    enable: "Enable",
    configure: "Configure",
    provider: "Provider",
    useDefault: "Use built-in default",
    customKey: "Use my own key",
    customStored: "Custom key stored",
    customKeyHint: "Custom values are stored encrypted and never shown back.",
    enableHint:
      "Pick a data source and enable this account type. You can add accounts right after.",
    cancel: "Cancel",
    saved: "Saved",
...
export const zh: Messages = {
  ...
  Settings: {
    ...
    stateActive: "已启用",
    stateOff: "未启用",
    stateUnconfigured: "待配置",
    enable: "启用",
    configure: "配置",
    provider: "数据源",
    useDefault: "使用内置默认",
    customKey: "使用自己的 key",
    customStored: "已存自定义 key",
    customKeyHint: "自定义值加密存储,绝不回显。",
    enableHint: "选择数据源并启用该账户类型,随后即可添加账户。",
    cancel: "取消",
    saved: "已保存",
    saveFailed: "保存失败",
    closeType: "关闭该类型",
