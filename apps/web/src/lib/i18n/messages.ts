...
const en = {
  ...
  Sync: {
    ...
    tallySynced: "{count} synced",
    tallyFailed: "{count} failed",
    tallyNeedsKeys: "{count} need keys",
    tallySkipped: "{count} skipped",
    ...
    syncingNow: "Now syncing",
    roundFailed: "Failed this round",
    roundInterrupted: "The last round stopped partway — sync again.",
    startFailed: "Couldn't start the sync",
    staleWarning: "No fresh data in over a day — 24h change has lost its baseline.",
...
const zh: Messages = {
  ...
  Sync: {
    ...
    roundProgress: "进度",
    roundResult: "本轮",
    tallySynced: "{count} 已同步",
    tallyFailed: "{count} 失败",
    tallyNeedsKeys: "{count} 缺凭据",
    tallySkipped: "{count} 跳过",
    lastUpdated: "上次更新",
    lastNever: "从未",
    needsAttention: "需要注意",
    ...
    syncingNow: "正在同步",
    roundFailed: "本轮失败",
    roundInterrupted: "上一轮没跑完 —— 再同步一次。",
    staleWarning: "超过一天没有新数据 —— 24h 盈亏已失去精确基准。",
    startFailed: "没能发起同步",
    hintResync: "点击重新同步",
