...
const en = {
  ...
  Overview: {
    ...
    gainExplainOpenValue: "held {value} going in",
    gainExplainTotal: "Total",
    gainExplainReturn: "Return",
    gainExplainWhyNot:
      "The return compounds each stretch — it isn't the total over the opening value, so the two won't divide out on a day you traded.",
    bestToday: "Top today",
...
const zh: Messages = {
  ...
  Overview: {
    ...
    gainExplainOpenValue: "这段开头拿着 {value}",
    gainExplainTotal: "合计",
    gainExplainReturn: "收益率",
    gainExplainWhyNot:
      "收益率是各段连乘出来的,不是「合计 ÷ 期初」—— 所以你动过仓的那天,这两个数除不通。",
    bestToday: "今日最佳",
    worstToday: "今日最差",
    stableShare: "稳定币占比",
    portfolioValue: "组合净值",
