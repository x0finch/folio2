...
📍 **地点**:`packages/oracle/entry/src/internal/mint.ts`,由 app 编排在写快照之前
...
| ② 认币 | `packages/oracle/entry/src/internal/mint.ts` · 编排 `apps/web/src/lib/server/internal/sync-deps.ts` |
