"use client";
// beui.dev/components/motion/drawer — @/ 别名已改写为 @folio/ui/*。
// 自包含侧滑面板(左/右):背景模糊 + spring + body scroll lock + esc 关闭。无 Trigger/Header 部件。

import { AnimatePresence, motion, useReducedMotion } from "motion/react";
import { useEffect, type ReactNode } from "react";
import { EASE_OUT, SPRING_PANEL } from "@folio/ui/lib/ease";
