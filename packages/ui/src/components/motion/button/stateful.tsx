"use client";
// beui.dev/components/motion/button — @/ 别名已改写为 @folio/ui/*。

import { AnimatePresence, motion, useReducedMotion, type Variants } from "motion/react";
import { Check, Loader2, X } from "lucide-react";
import { forwardRef, useLayoutEffect, useRef, useState, type ReactNode } from "react";
import { EASE_OUT, SPRING_SWAP } from "@folio/ui/lib/ease";
...
export const StatefulButton = forwardRef<HTMLButtonElement, StatefulButtonProps>(
  function StatefulButton(
    { state = "idle", children, loadingText = "Loading", successText = "Done", errorText = "Try again", icon, disabled, ...rest },
    ref,
  ) {
